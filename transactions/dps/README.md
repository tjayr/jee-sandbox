dps: Example Using Multiple Java EE 6 Technologies Deployed as an EAR
==============================================================================================
Author: Pete Muir
Level: Intermediate
Technologies: EAR
...
4. This will deploy `target/dps.ear` to the running instance of the server.


Access the application 
---------------------

The application will be running at the following URL: <http://localhost:8080/dps-web>.
...
You should see messages similar to the following:
    ...
    INFO  [com.clearprecision.dps.controller.MemberRegistration] (http--127.0.0.1-8080-2) Registering Jane Doe
    INFO  [com.clearprecision.dps.test.MemberRegistrationTest] (http--127.0.0.1-8080-2) Jane Doe was persisted with id 1
    ...
    INFO  [org.jboss.as.connector.subsystems.datasources] (MSC service thread 1-5) JBAS010409: Unbound data source [jboss/datasources/dpsTestDS]
