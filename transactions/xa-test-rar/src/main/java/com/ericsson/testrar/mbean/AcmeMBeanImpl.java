 ...
 */
package com.ericsson.testrar.mbean;
...
public class AcmeMBeanImpl implements AcmeMBean
{
    ...
    */
   private AcmeConnection getConnection() throws Exception
   {
      InitialContext context = new InitialContext();
      AcmeConnectionFactory factory = (AcmeConnectionFactory)context.lookup(JNDI_NAME);
      AcmeConnection conn = factory.getConnection();
      if (conn == null)
      {
