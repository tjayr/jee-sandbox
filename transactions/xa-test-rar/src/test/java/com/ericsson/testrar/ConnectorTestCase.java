...
public class ConnectorTestCase
{
   ...
   public static ResourceAdapterArchive createDeployment()
   {
      ...
      ja.addClasses(AcmeResourceAdapter.class, AcmeManagedConnectionFactory.class, AcmeManagedConnection.class, AcmeConnectionFactory.class, AcmeConnectionFactoryImpl.class, AcmeConnection.class, AcmeConnectionImpl.class);
      raa.addAsLibrary(ja);
